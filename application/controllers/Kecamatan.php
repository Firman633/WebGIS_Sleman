...
class Kecamatan extends CI_Controller {
	...
	public function __construct(){
	    ...
	    $this->load->model('KecamatanModel','Model');//fungsi ntuk memanggil model (KecamatanModel) dan di namai dengan Model
	}
	...
	{
		$datacontent['url']='kecamatan';
		$datacontent['parameter']=$parameter;//parameter untuk mengirimkan informasi bahwasnya baru melakukan proses apa
		$datacontent['id']=$id;//untuk mengirimkan informasi id
